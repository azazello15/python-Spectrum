...
r5 = r'(компания)|(диджитал бизнес)|(китобизнес)'
    ...
    for line3 in manager['text']:
        if re.search(r3, line3):
            ...
            if re.search(r4, line3):
                ...
                print('менеджеры не представились')
            if re.search(r5, line3):
                print('менеджеры представили компанию')
            else:
                print('менеджерыы забыли где работают')
